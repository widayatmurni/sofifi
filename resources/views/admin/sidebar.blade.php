<div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
  ...
  </div></div></div></div><div class="simplebar-placeholder" style="width: 224px; height: 736px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 119px; transform: translate3d(0px, 57px, 0px); display: block;"></div></div></ul>
